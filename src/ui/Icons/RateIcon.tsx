...
export const RateIcon = (props: any) => {
  ...
  switch (rate) {
    case 'A':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10" {...iconProps}>
          <path
            fill="#fff"
    ...
    case 'B':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="10" fill="none" viewBox="0 0 8 10" {...iconProps}>
          <path
            fill="#fff"
    ...
    case 'D':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="10" fill="none" viewBox="0 0 9 10" {...iconProps}>
          <path
            fill="#fff"
    ...
    case 'AA':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="10" fill="none" viewBox="0 0 15 10" {...iconProps}>
          <path
            fill="#fff"
    ...
    case 'AAA':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="10" fill="none" viewBox="0 0 22 10" {...iconProps}>
          <path
            fill="#fff"
            fillRule="evenodd"
