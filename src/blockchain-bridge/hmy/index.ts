...
export const hmyMethodsS1HRC721 = erc721Builder(process.env.HMY_S1HRC721_MANAGER_CONTRACT, process.env.S1HRC721_TOKEN_MANAGER_CONTRACT);
export const hmyMethodsHRC721 = hrc721Builder(process.env.HMY_HRC721_MANAGER_CONTRACT);
export const hmyMethodsS0HRC721 = hrc721Builder(process.env.HMY_S0HRC721_MANAGER_CONTRACT);
...
export const hmyMethodsS1HRC1155 = erc1155Builder(process.env.HMY_S1HRC1155_MANAGER_CONTRACT, process.env.HMY_S1HRC1155_MANAGER_TOKEN);
export const hmyMethodsHRC1155 = hrc1155Builder(process.env.HMY_HRC1155_MANAGER_CONTRACT);
export const hmyMethodsS0HRC1155 = hrc1155Builder(process.env.HMY_S0HRC1155_MANAGER_CONTRACT);
