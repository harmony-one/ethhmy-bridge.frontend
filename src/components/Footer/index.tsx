    ...
    >
      ...
      <Box direction="row" align="baseline" gap="89px">
        <Box>
          ...
          <a href="https://scrt.network/blog" style={{ textDecoration: 'none', marginTop: '16px', color: '#fff' }} target="_blank">
            <Text>Blog</Text>
          </a>
        </Box>
        ...
        <Box>
          ...
          <a href="https://puzzle.report/" style={{ textDecoration: 'none', marginTop: '16px', color: '#fff' }} target="_blank">
            <Text>Puzzle</Text>
          </a>
          <a href="http://www.secretanalytics.xyz/" style={{ textDecoration: 'none', marginTop: '16px', color: '#fff' }} target="_blank">
