  ...
  const raw = Object.keys(process.env)
    ...
    .reduce(
      ...
      },
      {
        ...
        HMY_S1HRC721_MANAGER_CONTRACT: process.env.HMY_S1HRC721_MANAGER_CONTRACT,
        S1HRC721_TOKEN_MANAGER_CONTRACT: process.env.S1HRC721_TOKEN_MANAGER_CONTRACT,
        HMY_S0HRC721_MANAGER_CONTRACT: process.env.HMY_S0HRC721_MANAGER_CONTRACT,

        HMY_S1HRC1155_MANAGER_CONTRACT: process.env.HMY_S1HRC1155_MANAGER_CONTRACT,
        HMY_S1HRC1155_MANAGER_TOKEN: process.env.HMY_S1HRC1155_MANAGER_TOKEN,
        HMY_S0HRC1155_MANAGER_CONTRACT: process.env.HMY_S0HRC1155_MANAGER_CONTRACT,

        HMY_S1HRC20_MANAGER_CONTRACT: process.env.HMY_S1HRC20_MANAGER_CONTRACT,
        TOKEN_MANAGER_CONTRACT_FOR_S1: process.env.TOKEN_MANAGER_CONTRACT_FOR_S1,
        HMY_S0HRC20_MANAGER_CONTRACT: process.env.HMY_S0HRC20_MANAGER_CONTRACT,
