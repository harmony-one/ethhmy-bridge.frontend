  ...
  const raw = Object.keys(process.env)
    ...
    .reduce(
      ...
      },
      {
        ...
        HMY_BHRC721_MANAGER_CONTRACT: process.env.HMY_BHRC721_MANAGER_CONTRACT,
        BEP721_TOKEN_MANAGER_CONTRACT: process.env.BEP721_TOKEN_MANAGER_CONTRACT,
        HMY_BEP721_MANAGER_CONTRACT: process.env.HMY_BEP721_MANAGER_CONTRACT,
        HMY_BEP1155_MANAGER_CONTRACT: process.env.HMY_BEP1155_MANAGER_CONTRACT,
        HMY_BEP1155_MANAGER_TOKEN: process.env.HMY_BEP1155_MANAGER_TOKEN,
        HMY_BHrc1155_MANAGER_CONTRACT: process.env.HMY_BHrc1155_MANAGER_CONTRACT,
        HMY_BHRC1155_MANAGER_CONTRACT: process.env.HMY_BHRC1155_MANAGER_CONTRACT,
        ...
        HMY_PERC721_MANAGER_CONTRACT: process.env.HMY_PERC721_MANAGER_CONTRACT,
        PERC721_TOKEN_MANAGER_CONTRACT: process.env.PERC721_TOKEN_MANAGER_CONTRACT,
        HMY_PHRC721_MANAGER_CONTRACT: process.env.HMY_PHRC721_MANAGER_CONTRACT,

        HMY_PERC1155_MANAGER_CONTRACT: process.env.HMY_PERC1155_MANAGER_CONTRACT,
        HMY_PERC1155_MANAGER_TOKEN: process.env.HMY_PERC1155_MANAGER_TOKEN,
        HMY_PHRC1155_MANAGER_CONTRACT: process.env.HMY_PHRC1155_MANAGER_CONTRACT,
